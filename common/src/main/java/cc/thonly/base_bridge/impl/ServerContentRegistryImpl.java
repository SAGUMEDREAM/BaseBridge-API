...
import cc.thonly.base_bridge.mixin.HolderReferenceAccessors;
...
public class ServerContentRegistryImpl implements ServerContentRegistry {
    ...
    public <T> Holder.Reference<T> bindReferenceHolder(WritableRegistry<T> writable, ResourceKey<T> resourceKey, T value) {
        ...
        referenceAccessors.setValue(value);
        return reference;
    }
